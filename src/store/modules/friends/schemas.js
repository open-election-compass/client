...
export const incomingDataSchema = yup.object().strict(true).noUnknown().shape({
  action: yup.string().required().oneOf(['SEND_PROFILE_TO_HOST', 'SEND_ANSWERS_TO_HOST', 'SEND_FRIEND_LIST_TO_GUESTS']),
