    ...
    >
      ...
      >
        <template v-slot:introduction>
          <p
            v-for="
              (explanation, index) in $t('elements.friends-join-modal.introduction.explanation')"
            :key="index"
          >
            {{ explanation }}
          </p>
        ...
        <template v-slot:security>
          <p
            v-for="
              (explanation, index) in $t('elements.friends-join-modal.security.explanation')"
            :key="index"
          >
            {{ explanation }}
          </p>
        ...
        <template v-slot:registration>
          <p
            v-for="
              (explanation, index) in $t('elements.friends-join-modal.registration.explanation')"
            :key="index"
          >
            {{ explanation }}
          </p>
